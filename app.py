    ...
    if not api_key:
        ...
        with st.chat_message("assistant"):
            with st.spinner("AI එක මගින් සවිස්තරාත්මක පිළිතුර සකස් කරමින් පවතියි..."):
                ...
                3. සමීකරණ ලිවීම (மிக වැදගත්): පිළිතුරු සැපයීමේදී කිසිදු සමීකරණයක් හෝ ගණනය කිරීමක් සඳහා වරහන් හෝ වරහන් තුළ `[...]` භාවිත කරන්න එපා. ඒ වෙනුවෙන් **තනි රේඛාවේ (Inline) සමීකරණ සඳහා `$ ... $` ද, වෙනම පේළිවල (Display) සමීකරණ සඳහා `$$ ... $$` ද** අනිවාර්යයෙන්ම භාවිත කරන්න. (උදාහරණයක් ලෙස: $$ \epsilon = \\frac{\Delta L}{L_0} $$ ලෙස ලියන්න).
